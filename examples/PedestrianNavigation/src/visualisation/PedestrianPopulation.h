...
{  
    ...
    "   //blend keyframes															\n"
    "	//data1.z = 0.5;															\n"
    "   vec3 lerp_position = mix(gl_Vertex.xyz, position_r, data1.w);				\n"
	...
	"	else																		\n"
    "		gl_FrontColor = vec4(0.0f, float(int(instance_index)/255)/255.0f, float(int(instance_index)%255)/255.0f, 1.0f);							\n"	
